...
params: 
    data: NA
    data1: P53_Wild-Type_vs_Normal_cells_Microarray_File.txt
    data2: NA
    data3: NA
    data4: NA
    class: P53_Cell_Phenotype_File.txt
    hallmarks: Hallmark_Genesets.txt
    results_hallmark: NA
    alg: SVM
    var: 10
    lowexpress: 10
...
#your_GSOA_results= read.table(params$data, header=T,sep='\t', quote="", row.names = 1)
